...
public class Patient extends Personne {
    ...
    public Patient(String nom, String prenom, String numeroDeTelephone, char sexe, long numSecu,
                   LocalDate dateNaissance, String commentaires, Adresse adresse) throws UtilisateurException, ProgrammeurException {
    ...
    public void setDateNaissance(LocalDate dateNaissance) throws UtilisateurException {
        if (dateNaissance.isBefore(LocalDate.now()))
            throw new UtilisateurException("la date de naissance doit être inferieur à la date du jour");
